...
export const SHEETS = {
  ...
  access: {
    ...
    lockedBody:
      'Приватное комьюнити откроется сразу после оформления подписки. Доступ работает, пока подписка активна: если её не продлить, он закроется.',
    lockedCta: 'Вступить',
    activeTitle: 'Доступ открыт',
    activeBody:
      'Ты в приватном Pocket Creator. Заходи и пиши в любое время. Доступ сохраняется, пока активна подписка — если её не продлить, он закроется.',
